...
u32 NVIC_GetPendingIRQ(IRQn_Type IRQn) ;	/*Reads the pending status of interrupt or exception. This function returns nonzero value if the pending status is set to 1.*/

u32 NVIC_GetActive (IRQn_Type IRQn);		 /*Return the IRQ number of the active interrupt*/

void NVIC_SetPriority(IRQn_Type IRQn, u8 priority); 	/*Sets the priority of an interrupt or exception with configurable priority level to 1.*/
